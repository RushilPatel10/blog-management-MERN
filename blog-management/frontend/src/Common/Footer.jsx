        ...
        <footer className="footer-section2">
            <div className="footer-top">
                <div className="container">
                    <div className="row ">
                        <div className="col-lg-12 justify-content-center  d-flex mb-70">
                            <div className="footer-top-content">
                                <a href="/"><img src="../assets/image/index-img/icon/light-logo.svg" alt="logo" /></a>
                                ...
                                <div className="our-activetis">
                                    <div className="row justify-content-center d-flex g-lg-4 gy-4">
                                            ...
                                            <a href="https://www.facebook.com/" className="social-area">
                                                <div className="icon">
                                                    <svg width={14} height={14} viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M7.81526 12.2482V7.46723H9.42818L9.66793 5.59531H7.81526V4.40298C7.81526 3.86281 7.96576 3.49298 8.74101 3.49298H9.72334V1.82406C9.24538 1.77284 8.76495 1.74811 8.28426 1.74998C6.85859 1.74998 5.87976 2.62031 5.87976 4.21806V5.59181H4.27734V7.46373H5.88326V12.2482H7.81526Z">
                                                        </path>
                                                    </svg>
                                                </div>
                                                <div className="number">
                                                    <h5 className="counter">122</h5>
                                                    <span>K</span>
                                                </div>
                                            </a>
                                        </div>
                        ...
                        <div className="copyright-area">
                            <p> © Copyright 2024 <a href="/"> Zorik </a> | Design By <a href="https://www.egenstheme.com/">EGENS THEME</a></p>
                        </div>
                    </div>
                </div>
            </div>
